...
一套奶油白、墨黑與鈷藍配色的 SillyTavern 第三方前端擴充。它不取代或搬移聊天資料，只以全螢幕介面操作 SillyTavern 現有角色、群組、訊息、世界書與生成設定。
...
- 對話重新命名
- 專注模式
- 世界書、生成設定、使用者設定與原生更多選單
- 每個聊天室獨立保存關係值、情緒標籤與重要記憶
- 桌機與手機版面
...
- 關係值、情緒與重要記憶寫入目前聊天室的 chatMetadata.molan_gallery。
